...
(function(factory){
	...
	Datepicker.prototype = {
		...
		getUTCDate: function(){
			let selected_date = this.dates.get(-1);
      ...
      let localDate = this._utc_to_local(this.viewDate);
		...
		_fill_yearsView: function(selector, cssClass, factor, year, startYear, endYear, beforeFn){
			...
			let startVal = Math.floor(year / factor) * factor;
			let endVal = startVal + step * 9;
			let focusedVal = Math.floor(this.viewDate.getFullYear() / step) * step;
			let selected = $.map(this.dates, function(d){
        ...
        titleBtnVisible = (this.o.todayBtn === true || this.o.todayBtn === 'linked') && todayDate >= this.o.startDate && todayDate <= this.o.endDate && !this.weekOfDateIsDisabled(todayDate),
			...
			this.updateNavArrows();
			this.fillMonths();
			let prevMonth = UTCDate(year, month, 0),
		...
		dayCellClick: function(e){
			...
			let timestamp = $target.data('date');
	...
	DateRangePicker.prototype = {
		...
		dateUpdated: function(e){
			...
			let dp = $.data(e.target, 'datepicker');

			if (dp === undefined) {
				return;
			}

			let new_date = dp.getUTCDate(),
